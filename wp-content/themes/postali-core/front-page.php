...
<div class="body-container">
    ...
    <section class="banner">
        <div class="columns">
            <div class="column-50 block">
                <div class="container">
                    ...
                    <div class="cta-wrapper">
                        ...
                        <?php $cta_group = get_field('banner_cta_group'); $cta_link = $cta_group['contact_link']; if( $cta_link ) :?>
            ...
            <div class="column-50 block">
                <?php $banner_img = get_field('banner_image'); if( $banner_img ) {
    ...
    <section class="featured-testimonial bg-lt-blue">
        ...
        <div class="wrapper mobile-testimonial">
            <div class="testimonial-image-slider">
                <?php if( have_rows('testimonial_mobile_slider_images') ) : $img_count = 0; while(have_rows('testimonial_mobile_slider_images')) : the_row(); 
                $img_count++; ?>
                <?php if( $img_count == 1 ) : ?>
                ...
                <?php endif; ?>
                <?php $mobile_img = get_sub_field('mobile_image'); if($mobile_img) : ?>
        ...
        <div class="container">
            ...
            <div class="columns">
                ...
                <div class="column-50">
                    ...
                    <?php $p1_button = get_field('p1_about_button'); if( $p1_button ) : ?>
            ...
            <div class="columns">
                <div class="column-50 block">
                    <div class="img-container">
                        <?php $p4_img = get_field('p4_left_column_image'); if( $p4_img ) { echo wp_get_attachment_image($p4_img['ID'], 'full'); } ?>
                ...
                <div class="column-50 block">
                    <?php if( have_rows('p4_featured_testimonials') ) : ?>
                        <div class="testimonial-slider">
                            <?php while( have_rows('p4_featured_testimonials') ) : the_row(); $testimonial_obj = get_sub_field('testimonial'); ?>
                                <div class="testimonial">
        ...
        <div class="container">
            <div class="columns">
                <div class="column-33 block">
                    ...
                    <?php $p5_btn = get_field('p5_button'); if( $p5_btn ) : ?>
                        <a title="navigate to attorney bio page" href="<?php echo $p5_btn['url']; ?>" class="btn"><?php echo $p5_btn['title']; ?></a>
                    <?php endif; ?>
                </div>
                <div class="column-66 block">
                    <div class="cornered-block">
                        <?php $p5_img = get_field('p5_right_column_image'); if( $p5_img ) { echo wp_get_attachment_image($p5_img['ID'], 'full'); } 
    ...
    <section class="panel-6 bg-red">
            ...
            <div class="column-full block">
                <?php if( have_rows('p6_steps') ) : $count = 0; ?>
                    <div class="steps-wrapper">
                        <?php while( have_rows('p6_steps') ) : the_row(); $count++; ?>
                            <div class="step">
        ...
        <div class="separator">
            ...
            <?php $p6_btn = get_field('p6_button'); if( $p6_btn ) : ?>
    ...
    <section class="cta">
        ...
        <?php $cta_img = get_field('cta_background_image'); if( $cta_img ) { echo wp_get_attachment_image($cta_img['ID'], 'full'); } ?>
        ...
        <div class="columns">
            ...
            <div class="right-col">
                <?php $cta_btn = get_field('cta_button'); if( $cta_btn ) : ?>
        ...
        <div class="container">
            <div class="columns">
                <div class="column-66 block">
                    ...
                    <?php $p7_btn = get_field('p7_all_faqs_button'); if( $p7_btn ) : ?>
        ...
        <div class="container">
            <div class="columns">
                <div class="column-full">
                    ...
                    <?php $p8_btn = get_field('p8_blog_button'); if( $p8_btn ) : ?>
                ...
                <div class="column-full block">
                    <?php if( have_rows('p8_posts') ) : $post_count = count( get_field('p8_posts') );?>
                        <div class="posts-grid posts-grid-<?php echo $post_count; ?>">
                            <?php while( have_rows('p8_posts') ) : the_row(); $post_obj = get_sub_field('post'); ?>
                                <div class="post">
                                    <?php $post_img = get_the_post_thumbnail( $post_obj->ID ); if( $post_img ) { echo $post_img; } ?>
    ...
    <?php $pre_footer = get_field('pre_footer_cta'); get_template_part('blocks/pre-footer', null, array('data' => [$pre_footer])); ?>
